...
//       <li
//         key={category.id}
//         className={`p-2 mb-2 rounded ${selectedCategory === category.name && !isParent ? 'bg-blue-600 text-white' : 'hover:bg-blue-100'} ${level > 0 ? 'pl-6 cursor-pointer' : 'cursor-pointer'}`}
//         onClick={() => {
//           if (!isParent) {
//             onCategorySelect(category);  // If it's not a parent category, just select the category
//           }
//         }}
//       >
//         <div className="flex justify-between items-center">
//           <span 
//             className={`${selectedCategory === category.name && !isParent ? 'text-white' : ''}`}
//             onClick={() => {
//               if (isParent) {
//                 onCategorySelect(category); // Select parent category without collapsing
//               }
//             }}
//           >
//             {category.name}
...
//             {category.subcategories.map(subcategory => renderCategories(subcategory, level + 1))} {/* Render subcategories */}
//           </ul>
//         )}
//       </li>
//     );
