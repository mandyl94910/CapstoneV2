  ...
  return (
    <header className="bg-white py-4 flex justify-between items-center shadow-md">
      ...
      <div className="flex items-center space-x-8">
        ...
        <Link href="/cart">
          <FaShoppingCart className="text-2xl cursor-pointer hover:text-blue-500" />{" "}
          {/* Increase size of the cart icon */}
        </Link>
        {user ? (
          ...
          <Link href="/login" className="pr-16">
            <button className="bg-blue-500 text-white rounded-lg px-4 py-2 font-medium">
              LOG IN
            </button>
          </Link>
        )}
