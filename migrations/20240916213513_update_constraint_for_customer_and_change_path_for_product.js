...
// VALUES ('Smartphone X1', 699.99, 'A high-end smartphone with advanced features.', 11, 50, 11, 'product/11/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Smartphone Y1', 799.99, 'A powerful smartphone with a sleek design.', 11, 40, 11, 'product/11/example.webp', TRUE);

// -- Phone Cases (folder 12)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Phone Case A', 19.99, 'Durable and stylish phone case.', 12, 200, 12, 'product/12/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Phone Case B', 15.99, 'Sleek phone case with a minimalist design.', 12, 150, 12, 'product/12/example.webp', TRUE);

// -- Headphones (folder 13)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Wireless Headphones', 89.99, 'Noise-canceling wireless headphones.', 13, 100, 13, 'product/13/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('In-Ear Headphones', 29.99, 'Comfortable in-ear headphones.', 13, 300, 13, 'product/13/example.webp', TRUE);

// -- Laptops (folder 15)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Laptop Pro 15', 1299.99, 'A powerful laptop for professionals.', 15, 30, 15, 'product/15/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Gaming Laptop Z1', 1599.99, 'A high-performance gaming laptop.', 15, 25, 15, 'product/15/example.webp', TRUE);

// -- Keyboards (folder 17)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Mechanical Keyboard', 79.99, 'A mechanical keyboard with RGB lighting.', 17, 120, 17, 'product/17/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Wireless Keyboard', 49.99, 'A wireless keyboard with long battery life.', 17, 80, 17, 'product/17/example.webp', TRUE);

// -- Monitors (folder 19)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('4K Monitor', 299.99, 'A 27-inch 4K monitor for work and gaming.', 19, 60, 19, 'product/19/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Ultrawide Monitor', 399.99, 'A 34-inch ultrawide monitor.', 19, 45, 19, 'product/19/example.webp', TRUE);

// -- Smart Speakers (folder 20)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Smart Speaker A1', 59.99, 'A voice-controlled smart speaker.', 20, 150, 20, 'product/20/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Smart Speaker B1', 89.99, 'A premium smart speaker with great sound quality.', 20, 80, 20, 'product/20/example.webp', TRUE);

// -- Televisions (folder 23)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Smart TV 55"', 599.99, 'A 55-inch 4K smart TV.', 23, 40, 23, 'product/23/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('OLED TV 65"', 1299.99, 'A 65-inch OLED 4K TV.', 23, 20, 23, 'product/23/example.webp', TRUE);

// -- Gaming Consoles (folder 26)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Next-Gen Console X', 499.99, 'A next-generation gaming console.', 26, 100, 26, 'product/26/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Gaming Console Y', 399.99, 'A budget-friendly gaming console.', 26, 120, 26, 'product/26/example.webp', TRUE);

// -- Cameras (folder 29)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('DSLR Camera A1', 899.99, 'A high-quality DSLR camera for photography.', 29, 35, 29, 'product/29/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Mirrorless Camera B1', 1199.99, 'A mirrorless camera with advanced features.', 29, 25, 29, 'product/29/example.webp', TRUE);

// -- Smartwatches (folder 32)
// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Smartwatch Pro', 199.99, 'A smartwatch with fitness tracking features.', 32, 90, 32, 'product/32/example.webp', TRUE);

// INSERT INTO product (product_name, price, product_description, category_id, quantity, folder, image, visibility) 
// VALUES ('Smartwatch Lite', 149.99, 'A lightweight smartwatch for everyday use.', 32, 120, 32, 'product/32/example.webp', TRUE);
